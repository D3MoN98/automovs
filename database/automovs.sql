...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2020 at 05:36 AM
...
(12, '2020_05_30_082418_create_roles_table', 1),
(13, '2020_05_30_082618_create_user_roles_table', 1),
(16, '2020_05_31_035829_create_vehicles_table', 2);
...
(1, 'admin', '2020-05-30 03:38:21', '2020-05-30 03:38:21'),
(2, 'customer', '2020-05-30 03:38:21', '2020-05-30 03:38:21');
...
(1, 'admin', 'admin@gmail.com', NULL, '$2y$10$jKLG7HUdAxJm.mY.HIQPxOglHOBOWYEhT1MtBk8atWDHhCLv9mJZq', 'KPqHYnKoQWpHTzqReotDFd7l4B4RXopb874ybdyVPdEk4bZXpVgVBRlbfDZM', '2020-05-30 03:43:15', '2020-05-30 09:09:46'),
(2, 'Sudipta jana', 'sjgalaxy@gmail.com', NULL, '$2y$10$k0ugX3cnmr9Qfx3FFi.o3.zrKy3cERk9sPjx/Gcp93ow3MiqUFSaS', NULL, '2020-05-30 05:07:27', '2020-05-30 10:04:30');
...
(1, 1, 1, '2020-05-30 03:43:15', '2020-05-30 03:43:15'),
(2, 2, 2, '2020-05-30 05:07:27', '2020-05-30 05:07:27');
...
CREATE TABLE `vehicles` (
  ...
  `year_bought` year(4) NOT NULL,
  `insurance` year(4) NOT NULL,
...
INSERT INTO `vehicles` (`id`, `user_id`, `brand`, `model`, `variant`, `registration_number`, `type`, `driven`, `color`, `year_bought`, `insurance`, `location`, `images`, `price`, `is_verified`, `verified_at`, `created_at`, `updated_at`) VALUES
(1, 1, 'Maruti Suzuki', 'Maruti 800', 'Hatchback', 'WB10X1234', '4-wheeler', 50000, 'Red', 2000, 2015, 1475, 'storage/vehicles/2b1lj7Wz3e7TMhSb05mduW65M9sk4fcVh0QURS3l.jpeg,storage/vehicles/ATit5pFB3MWqbicIpOVuQhg0un7LjKF48XNjM4qw.jpeg,storage/vehicles/UQjI9uSVjPt4U0MZjz0Tx5B98RjdwaKS8dxuY2cz.jpeg', 50000, 0, NULL, '2020-05-31 01:58:52', '2020-05-31 01:58:52');
...
ALTER TABLE `vehicles`
  ...
  ADD KEY `vehicles_location_foreign` (`location`);
...
--
ALTER TABLE `cities`
  ADD CONSTRAINT `city_relates_to_state` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `vehicles`
  ADD CONSTRAINT `vehicles_location_foreign` FOREIGN KEY (`location`) REFERENCES `cities` (`id`) ON DELETE CASCADE,
