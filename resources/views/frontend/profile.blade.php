        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-ps-chng" role="tabpanel"
                        aria-labelledby="v-pills-ps-chng-tab">
                    ...
                    <div class="tab-pane fade" id="v-pills-veh-pur" role="tabpanel"
                        aria-labelledby="v-pills-veh-pur-tab">
                        <ul class="list-group">
