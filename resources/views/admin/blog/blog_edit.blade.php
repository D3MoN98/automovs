            ...
            <div class="panel-body">
                <div class="position-center">
                    <form class="cmxform form-horizontal" id="blogForm" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="title" value="{{$blog->title}}"
                                    minlength="2" name="blog[title]" placeholder="Title" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="blog_categories" class="col-lg-2 col-sm-2 control-label">Blog Category</label>
                            <div class="col-lg-10">
                                <select class="form-control custom-select2" id="blog_categories"
                                    name="blog[blog_categories]" required>
                                    <option value=""></option>
                                    @foreach ($blog_categories as $blog_category)
                                    <option {{$blog_category->id == $blog->blog_category_id ? 'selected' : ''}}
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new fileupload-preview thumbnail">
                                        ...
                                        <div class="img-thumbnail-otr">
                                            <i class="fa fa-times-circle img-delete" data-value="{{$image}}"
                                                aria-hidden="true"></i>
